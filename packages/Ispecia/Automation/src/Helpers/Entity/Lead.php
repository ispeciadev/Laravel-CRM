...
namespace Ispecia\Automation\Helpers\Entity;

use Illuminate\Support\Facades\Mail;
use Ispecia\Activity\Repositories\ActivityRepository;
use Ispecia\Admin\Notifications\Common;
use Ispecia\Attribute\Repositories\AttributeRepository;
use Ispecia\Automation\Repositories\WebhookRepository;
use Ispecia\Automation\Services\WebhookService;
use Ispecia\Contact\Repositories\PersonRepository;
use Ispecia\EmailTemplate\Repositories\EmailTemplateRepository;
use Ispecia\Lead\Contracts\Lead as ContractsLead;
