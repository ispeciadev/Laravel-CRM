...
return [
    'trigger_entities' => [
        ...
        'leads' => [
            'name'   => 'Leads',
            'class'  => 'Ispecia\Automation\Helpers\Entity\Lead',
            'events' => [
                [
        ...
        'activities' => [
            'name'   => 'Activities',
            'class'  => 'Ispecia\Automation\Helpers\Entity\Activity',
            'events' => [
                [
        ...
        'persons' => [
            'name'   => 'Persons',
            'class'  => 'Ispecia\Automation\Helpers\Entity\Person',
            'events' => [
                [
        ...
        'quotes' => [
            'name'   => 'Quotes',
            'class'  => 'Ispecia\Automation\Helpers\Entity\Quote',
            'events' => [
                [
