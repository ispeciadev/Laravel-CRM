...
use Ispecia\Admin\Exceptions\Handler;
use Ispecia\Admin\Http\Middleware\Bouncer as BouncerMiddleware;
use Ispecia\Admin\Http\Middleware\Locale;
...
class AdminServiceProvider extends ServiceProvider
{
    ...
    public function boot(Router $router): void
    {
        ...
        Relation::morphMap([
            'leads'         => \Ispecia\Lead\Models\Lead::class,
            'organizations' => \Ispecia\Contact\Models\Organization::class,
            'persons'       => \Ispecia\Contact\Models\Person::class,
            'products'      => \Ispecia\Product\Models\Product::class,
            'quotes'        => \Ispecia\Quote\Models\Quote::class,
            'warehouses'    => \Ispecia\Warehouse\Models\Warehouse::class,
        ]);
    ...
    protected function registerFacades(): void
    {
        ...
        $loader->alias('Bouncer', \Ispecia\Admin\Facades\Bouncer::class);

        $this->app->singleton('bouncer', function () {
            return new \Ispecia\Admin\Bouncer;
        });
    }
