...
namespace Ispecia\Admin\Http\Controllers\Configuration;
...
use Ispecia\Admin\Http\Requests\ConfigurationForm;
use Ispecia\Core\Repositories\CoreConfigRepository as ConfigurationRepository;
