...
namespace Ispecia\Admin\Http\Requests;
...
class LeadForm extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $this->rules['website'] = 'nullable|string';
        $this->rules['linkedin_url'] = 'nullable|string';
        $this->rules['lead_rating'] = 'nullable|integer|min:1|max:5';
        $this->rules['employee_count'] = 'nullable|integer|min:0';
        $this->rules['person.job_title'] = 'nullable|string';
