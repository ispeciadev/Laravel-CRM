...
use Ispecia\Admin\Http\Controllers\Settings\AttributeController;
use Ispecia\Admin\Http\Controllers\Settings\DataTransfer\ImportController;
use Ispecia\Admin\Http\Controllers\Settings\EmailAccountController;
use Ispecia\Admin\Http\Controllers\Settings\EmailTemplateController;
use Ispecia\Admin\Http\Controllers\Settings\GroupController;
use Ispecia\Admin\Http\Controllers\Settings\LocationController;
use Ispecia\Admin\Http\Controllers\Settings\Marketing\CampaignsController;
use Ispecia\Admin\Http\Controllers\Settings\Marketing\EventController;
use Ispecia\Admin\Http\Controllers\Settings\PipelineController;
use Ispecia\Admin\Http\Controllers\Settings\RoleController;
use Ispecia\Admin\Http\Controllers\Settings\SettingController;
use Ispecia\Admin\Http\Controllers\Settings\SourceController;
use Ispecia\Admin\Http\Controllers\Settings\TagController;
use Ispecia\Admin\Http\Controllers\Settings\TypeController;
use Ispecia\Admin\Http\Controllers\Settings\UserController;
use Ispecia\Admin\Http\Controllers\Settings\Warehouse\ActivityController;
use Ispecia\Admin\Http\Controllers\Settings\Warehouse\TagController as WarehouseTagController;
use Ispecia\Admin\Http\Controllers\Settings\Warehouse\WarehouseController;
use Ispecia\Admin\Http\Controllers\Settings\WebFormController;
use Ispecia\Admin\Http\Controllers\Settings\WebhookController;
use Ispecia\Admin\Http\Controllers\Settings\WorkflowController;
...
Route::prefix('settings')->group(function () {
     ...
     */
    Route::controller(EmailAccountController::class)->prefix('email-accounts')->group(function () {
        Route::get('', 'index')->name('admin.settings.email_accounts.index');

        Route::get('create', 'create')->name('admin.settings.email_accounts.create');

        Route::post('create', 'store')->name('admin.settings.email_accounts.store');

        Route::get('edit/{id?}', 'edit')->name('admin.settings.email_accounts.edit');

        Route::put('edit/{id}', 'update')->name('admin.settings.email_accounts.update');

        Route::delete('{id}', 'destroy')->name('admin.settings.email_accounts.delete');

        Route::post('mass-destroy', 'massDestroy')->name('admin.settings.email_accounts.mass_delete');

        Route::post('{id}/test-connection', 'testConnection')->name('admin.settings.email_accounts.test_connection');
    });
