        ...
        >
            ...
            >
                <template #header="{
                    ...
                    <template v-else>
                        <div class="row grid grid-cols-[2fr_7fr_1fr] grid-rows-1 items-center border-b px-8 py-4 dark:border-gray-800 max-lg:hidden">
                            <div
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label>
                                    @lang('admin::app.mail.index.mail.from-account')
                                </x-admin::form.control-group.label>

                                <x-admin::form.control-group.control
                                    type="select"
                                    name="email_account_id"
                                    v-model="draft.email_account_id"
                                    :label="trans('admin::app.mail.index.mail.from-account')"
                                >
                                    @php
                                        $emailAccounts = app(\Ispecia\Email\Repositories\EmailAccountRepository::class)->getActiveAccounts();
                                    @endphp
                            ...
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    @lang('admin::app.mail.index.mail.schedule')
                                </label>
                                ...
                                <input
                                    ...
                                    class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300"
                                    placeholder="@lang('admin::app.mail.index.mail.schedule-placeholder')"
                                />
                            </div>
                        </x-slot>
