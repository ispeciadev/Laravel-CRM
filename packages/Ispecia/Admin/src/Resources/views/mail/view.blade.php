            ...
            <div class="box-shadow flex gap-2.5 rounded bg-white p-4 dark:bg-gray-900 max-xl:flex-wrap">
                <div class="flex w-full flex-col gap-4">
                    <div class="flex w-full items-center justify-between gap-4">
                        ...
                        <!-- Time and Actions -->
                        <div class="flex flex-col items-end justify-center gap-1 dark:text-gray-300">
                            <div class="flex items-center gap-2">
                                @{{ email.time_ago }}
                            ...
                            <div class="flex flex-col gap-1 mt-1">
                                <!-- Opened Badge -->
                                <span 
                                    v-show="email.opened_at" 
                                    class="inline-flex w-fit items-center gap-1 rounded-full bg-green-100 px-2.5 py-1 text-xs font-semibold text-green-800 dark:bg-green-900 dark:text-green-200"
                                >
                                    <span class="icon-eye"></span>
                                    Opened @{{ email.open_count || 0 }}x
                                </span>
                                
                                <!-- Sent Badge -->
                                <span 
                                    v-show="email.sent_at && !email.opened_at" 
                                    class="inline-flex w-fit items-center gap-1 rounded-full bg-blue-100 px-2.5 py-1 text-xs font-semibold text-blue-800 dark:bg-blue-900 dark:text-blue-200"
                                >
                                ...
                                <!-- Timestamp -->
                                <small v-show="email.opened_at" class="text-gray-500 dark:text-gray-400">
                                    Last opened: @{{ new Date(email.opened_at).toLocaleString() }}
                                </small>
                                <small v-show="email.sent_at && !email.opened_at" class="text-gray-500 dark:text-gray-400">
