@php
    $quote = app('\Ispecia\Quote\Repositories\QuoteRepository')->getModel();
                    ...
                    >
                        ...
                        <div class="w-1/2 max-md:w-full">
                            ...
                            <div class="flex gap-4">
                                ...
                                @php
                                    $lookUpEntityData = app('Ispecia\Attribute\Repositories\AttributeRepository')->getLookUpEntity('leads', request('lead_id'));
                                @endphp
