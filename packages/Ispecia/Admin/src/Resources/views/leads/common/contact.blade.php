...
@pushOnce('scripts')
    ...
    >
        ...
        <x-admin::form.control-group>
            ...
            <x-admin::form.control-group.error control-name="person[job_title]" />
        </x-admin::form.control-group>
        ...
        <x-admin::form.control-group>
            ...
            @php
                $organizationAttribute = app('Ispecia\Attribute\Repositories\AttributeRepository')->findOneWhere([
                    'entity_type' => 'persons',
