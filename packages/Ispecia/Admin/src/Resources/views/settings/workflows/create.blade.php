    ...
    @pushOnce('scripts')
        ...
        <script type="module">
            app.component('v-workflow', {
                ...
                data() {
                    return {
                        events: @json(app('\Ispecia\Automation\Helpers\Entity')->getEvents()),
        ...
        <script type="module">
            app.component('v-workflow-condition-item', {
                ...
                data() {
                    return {
                        conditions: @json(app('\Ispecia\Automation\Helpers\Entity')->getConditions()),
        ...
        <script type="module">
            app.component('v-workflow-action-item', {
                ...
                data() {
                    return {
                        actions: @json(app('\Ispecia\Automation\Helpers\Entity')->getActions()),
                    };
                },
