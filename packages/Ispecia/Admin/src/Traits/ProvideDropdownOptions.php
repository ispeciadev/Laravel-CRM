...
namespace Ispecia\Admin\Traits;
...
trait ProvideDropdownOptions
{
    ...
    {
        $options = app(\Ispecia\User\Repositories\UserRepository::class)
    ...
    {
        $options = app(\Ispecia\Lead\Repositories\SourceRepository::class)
            ->get(['id as value', 'name as label'])
            ->map(function ($item, $key) {
                $item->disabled = false;
    ...
    {
        $options = app(\Ispecia\Contact\Repositories\OrganizationRepository::class)
            ->get(['id as value', 'name as label'])
            ->map(function ($item, $key) {
                $item->disabled = false;
    ...
    {
        $options = app(\Ispecia\Warehouse\Repositories\WarehouseRepository::class)
            ->get(['id as value', 'name as label'])
            ->map(function ($item, $key) {
                $item->disabled = false;
