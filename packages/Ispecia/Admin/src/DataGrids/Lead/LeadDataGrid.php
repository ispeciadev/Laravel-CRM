...
namespace Ispecia\Admin\DataGrids\Lead;
...
class LeadDataGrid extends DataGrid
{
     ...
     * Pipeline instance.
     *
     * @var \Ispecia\Contract\Repositories\Pipeline
     */
    protected $pipeline;
    ...
    public function prepareQueryBuilder(): Builder
    {
        ...
        if (! is_null(request()->input('rotten_lead.in'))) {
            $rottenLeadValue = (int) request()->input('rotten_lead.in');
    ...
    public function prepareColumns(): void
    {
        ...
        $this->addColumn([
            ...
            'filterable_type'    => 'searchable_dropdown',
            'filterable_options' => [
                'repository' => \Ispecia\Contact\Repositories\PersonRepository::class,
                'column'     => [
                    'label' => 'name',
                    'value' => 'name',
                ],
