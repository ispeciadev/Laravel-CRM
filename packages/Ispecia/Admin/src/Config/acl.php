...
return [
    [
        ...
        'key'   => 'settings.automation.email_accounts',
        'name'  => 'admin::app.acl.email-accounts',
        'route' => 'admin.settings.email_accounts.index',
        'sort'  => 8,
    ], [
        'key'   => 'settings.automation.email_accounts.create',
        'name'  => 'admin::app.acl.create',
        'route' => ['admin.settings.email_accounts.create', 'admin.settings.email_accounts.store'],
        'sort'  => 1,
    ], [
        'key'   => 'settings.automation.email_accounts.edit',
        'name'  => 'admin::app.acl.edit',
        'route' => ['admin.settings.email_accounts.edit', 'admin.settings.email_accounts.update'],
        'sort'  => 2,
    ], [
        'key'   => 'settings.automation.email_accounts.delete',
        'name'  => 'admin::app.acl.delete',
        'route' => ['admin.settings.email_accounts.delete', 'admin.settings.email_accounts.mass_delete'],
        'sort'  => 3,
    ], [
