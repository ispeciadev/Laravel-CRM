<x-admin::layouts>
    ...
    <div class="flex flex-col gap-6">
        <x-admin::form :action="route('admin.deals.update', $deal->id)" method="PUT">
            <div class="flex flex-col gap-6">
                <!-- Header -->
                <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900">
                    <div class="flex flex-col gap-2">
                        <x-admin::breadcrumbs name="deals.edit" :entity="$deal" />

                        <div class="text-xl font-bold dark:text-white">Edit Deal</div>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Update deal information and track progress</p>
                    </div>

                    <div class="flex items-center gap-x-2.5">
                        {!! view_render_event('admin.deals.edit.create_button.before', ['deal' => $deal]) !!}

                        <button type="submit" class="primary-button">
                            Save
                        </button>

                        {!! view_render_event('admin.deals.edit.create_button.after', ['deal' => $deal]) !!}
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                required
                                value="{{ old('deal_value', $deal->deal_value) }}"
                            >
                        </div>
                        @error('deal_value')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
